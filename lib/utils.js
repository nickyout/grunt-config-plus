...
module.exports = function(grunt, ROOT) { return {
    ...
    write: function()
    {
        grunt.log.write(ROOT.style.indent + this._parseLog(arguments));
    },

    verbose: function()
    {
        grunt.verbose.write(ROOT.style.indent + this._parseLog(arguments));
    },
    ...
    appendVerbose: function()
    {
        grunt.verbose.write(this._parseLog(arguments));
    },
